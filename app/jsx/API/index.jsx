...
export default class App extends BaseComponent {
  ...
  checkAuthorized() {
    if (!this.isAuthorized()) {
      ...
      global.navigationIds = this.auth.editing_navigation_ids;
    }
  }
  ...
  componentDidMount() {
    ...
    RailsApp.cable.subscriptions.create("EditNavigationChannel", {
      received: (data) => {
        global.navigationIds = data.navigation_ids;
      }
    });
  }
